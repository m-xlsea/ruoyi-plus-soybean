...
onMounted(() => {
  ...
  initWebSocket(
    `${protocol}${window.location.host}${import.meta.env.VITE_APP_BASE_API}${import.meta.env.VITE_APP_MESSAGE_PATH}`
  );
  initSSE(`${import.meta.env.VITE_APP_BASE_API}${import.meta.env.VITE_APP_MESSAGE_PATH}`);
});
</script>
